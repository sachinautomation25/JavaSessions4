...
public class Test2 {
	...
	int a;//class properties-variables+methods, variabe are also called instance variable
	String name;
	...
	public static void main(String[] args) {
		...
		//JVM reserved 512 MB memory-->out of this JVM divide memory into 5 parts-->class area,heap area,stack area,pc register,method area area to store different things
